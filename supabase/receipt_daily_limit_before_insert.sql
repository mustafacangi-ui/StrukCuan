...
grant execute on function public.create_receipt(text, text, text, integer, integer) to authenticated;
grant execute on function public.get_receipts_today_count(text) to authenticated;
